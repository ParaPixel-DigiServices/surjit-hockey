...
function SortableItem({ id, team, onRemove }) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex items-center gap-3 bg-[#0b1530] p-3 rounded-md border border-white/6"
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="text-sm text-red-400 px-2 py-1 rounded hover:bg-red-500/10"
        >
          Remove
        </button>
      </div>
            ...
            >
              ...
              >
                <div className="space-y-2">
                  ...
                  {items.length === 0 && (
                    <div className="text-white/60 p-4 rounded-md border border-white/6">
          ...
          <div>
            ...
            <div className="space-y-2 max-h-80 overflow-y-auto">
              {available.map((t) => (
                <div
                  key={t.id}
                  className="flex items-center justify-between bg-[#0b1530] p-3 rounded-md border border-white/6"
                >
                  ...
                  <button
                    onClick={() => handleAdd(t)}
                    className="bg-[#ffd700] text-[#071226] px-3 py-1 rounded-md"
                  >
                    Add
                  </button>
                </div>
              ...
              {available.length === 0 && (
                <div className="text-white/60">No more teams available</div>
              )}
            </div>
          </div>
        </div>
